...
b,!1,{ passive: false });c&&a.addEventListener("touchmove",function(a){a.preventDefault()},!1,{ passive: false })}:function(a,b){a.onclick=b};n=function(a,b,c){var f=a.className,e=[];if(-1!==f.indexOf(b)){e=f.split(" ");for(f=e.length;f--;)e[f]===b&&(" "===c||""===c?e.splice(f,1):e[f]=c);e.length?a.className=e.join(" "):(a.removeAttribute("class"),a.removeAttribute("className"))}};M&&(R=function(a,b){var c=v[b].className;n(v[a],"active"," ");v[b].className=""===c?"active":c+" active"});f.continuous&&(p=function(a,b){var c=u;if(b)if(a>=
...
d+=""===k?20:0;h=b;b=a;M&&R(h,b);setTimeout(function(){c[a].className+=" slide"},d);setTimeout(function(){H[a][k+"TransitionDuration"]=B+"ms"},20);setTimeout(function(){n(c[h],"current","");n(c[b],"slide","current");f.callback&&f.callback(b,c[b]);t=!1},B+C+120)}};I();h=c[b].className;c[b].className=-1!==h.indexOf("current")?h:h+" current";for(z?window.addEventListener("resize",I,!1,{ passive: false }):window.onresize=I;V--;)(function(a){switch(!0){case "wheel"===a:Y=function(a){a=a||window.event;a.preventDefault?a.preventDefault():
a.returnValue=!1;t||(a=-a.wheelDelta||a.detail,y(b+(0>a?-1:1)))};z&&document.addEventListener("DOMMouseScroll",Y,!1,{ passive: false });window.onmousewheel=document.onmousewheel=Y;break;case "touch"===a:if(!z)break;(function(){var a=x.transform.scale[0],d=x.transform.scale[1]-a,h=x.transform.rotate[0],e=x.transform.rotate[1]-h,N=x.opacity[0],v=x.opacity[1]-N,w,y,z,C,I,q={},D=!1,L=-1===navigator.userAgent.indexOf("Windows Phone")?!1:!0,l,m,F,J,S,G,K,O;K=!P&&L?window.navigator.msPointerEnabled?{start:"MSPointerDown",
